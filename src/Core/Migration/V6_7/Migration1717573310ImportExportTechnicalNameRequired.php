...
class Migration1717573310ImportExportTechnicalNameRequired extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        if (DbTableHelper::columnExists($schemaManager, ImportExportProfileDefinition::ENTITY_NAME, 'technical_name')
            && !DbTableHelper::getColumnOfTable($schemaManager, ImportExportProfileDefinition::ENTITY_NAME, 'technical_name')->getNotnull()
        ) {
