...
class Migration1697112043AddPaymentAndShippingTechnicalName extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        if (!DbTableHelper::indexExists($schemaManager, PaymentMethodDefinition::ENTITY_NAME, 'uniq.technical_name')) {
        ...
        if (!DbTableHelper::indexExists($schemaManager, ShippingMethodDefinition::ENTITY_NAME, 'uniq.technical_name')) {
