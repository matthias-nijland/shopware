...
class CustomerDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new OneToOneAssociationField('defaultBillingAddress', 'default_billing_address_id', 'id', CustomerAddressDefinition::class, false))->addFlags(new ApiAware(), new SearchRanking(SearchRanking::ASSOCIATION_SEARCH_RANKING))->setDescription('Default billing address for the customer'),
            ...
            (new OneToOneAssociationField('defaultShippingAddress', 'default_shipping_address_id', 'id', CustomerAddressDefinition::class, false))->addFlags(new ApiAware(), new SearchRanking(SearchRanking::ASSOCIATION_SEARCH_RANKING))->setDescription('Default shipping address for the customer'),
