...
class Migration1753799632FixStateMachineHistoryIntegrationConstraintTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        $foreignKey = DbTableHelper::getForeignKeyOfTable($this->connection->createSchemaManager(), StateMachineHistoryDefinition::ENTITY_NAME, 'fk.state_machine_history.integration_id');
