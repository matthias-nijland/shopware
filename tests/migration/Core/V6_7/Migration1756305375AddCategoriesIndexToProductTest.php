...
class Migration1756305375AddCategoriesIndexToProductTest extends TestCase
{
    ...
    public function testIndexIsCreated(): void
    {
        ...
        if (DbTableHelper::indexExists($schemaManager, 'product', 'idx.product.categories')) {
        ...
        static::assertTrue(DbTableHelper::indexExists($schemaManager, 'product', 'idx.product.categories'));
    }
    ...
    public function testMigrationIsIdempotent(): void
    {
        ...
        static::assertTrue(DbTableHelper::indexExists($this->connection->createSchemaManager(), 'product', 'idx.product.categories'));
    }
}
