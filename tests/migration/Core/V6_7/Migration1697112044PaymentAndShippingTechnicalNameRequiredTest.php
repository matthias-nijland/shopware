...
class Migration1697112044PaymentAndShippingTechnicalNameRequiredTest extends TestCase
{
    ...
    public function testMigrate(): void
    {
        ...
        $paymentMethodTechnicalNameColumn = DbTableHelper::getColumnOfTable($schemaManager, PaymentMethodDefinition::ENTITY_NAME, 'technical_name');
        static::assertTrue($paymentMethodTechnicalNameColumn->getNotnull());

        $shippingMethodTechnicalNameColumn = DbTableHelper::getColumnOfTable($schemaManager, ShippingMethodDefinition::ENTITY_NAME, 'technical_name');
