...
class Migration1740563553AddAppRequestedPrivilegesTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        static::assertFalse(DbTableHelper::columnExists($schemaManager, 'app', 'requested_privileges'));

        $migration = new Migration1740563553AddAppRequestedPrivileges();
        $migration->update($this->connection);
        $migration->update($this->connection);

        static::assertTrue(DbTableHelper::columnExists($schemaManager, 'app', 'requested_privileges'));
    }
}
