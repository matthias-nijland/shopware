...
class Migration1752750086AddIndexToOrderLineItemCreateAndUpdateTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        static::assertTrue(DbTableHelper::indexExists($schemaManager, 'order_line_item', 'idx.order_line_item_created_updated'));
    }

    private function rollback(MySQLSchemaManager $schemaManager): void
    {
        if (DbTableHelper::indexExists($schemaManager, 'order_line_item', 'idx.order_line_item_created_updated')) {
