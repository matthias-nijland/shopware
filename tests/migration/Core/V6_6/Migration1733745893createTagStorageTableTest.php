...
class Migration1733745893createTagStorageTableTest extends TestCase
{
    ...
    public function testTableIsCreated(): void
    {
        ...
        static::assertFalse($schemaManager->tableExists('invalidation_tags'));
        ...
        static::assertTrue($schemaManager->tableExists('invalidation_tags'));

        static::assertTrue(DbTableHelper::columnExists($schemaManager, 'invalidation_tags', 'tag'));
        static::assertTrue(DbTableHelper::columnExists($schemaManager, 'invalidation_tags', 'id'));
    }
}
