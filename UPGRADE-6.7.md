...
The inner video blocks of `cms-block-vimeo-video.html.twig` and `cms-block-youtube-video.html.twig` called `block_image_inner` have been deprecated and will be removed in the next major version. Please specific blocks `block_vimeo_video_inner` and `block_youtube_video_inner` instead.
